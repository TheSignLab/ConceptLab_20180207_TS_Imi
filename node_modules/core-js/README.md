...
```
ECMAScript 7 [  functions](https://tc39.github.io/ecmascript- await) [example](http://goo.gl/wnQS4j):
```js
...
```
```
* `Symbol. Iterator` for [  iteration proposal](https://github.com/tc39/proposal- -iteration) - module [`es7.symbol. -iterator`](https://github.com/zloirock/core-js/blob/v2.5.3/modules/es7.symbol. -iterator.js)
```js
Symbol
  . Iterator -> @@ Iterator
```
