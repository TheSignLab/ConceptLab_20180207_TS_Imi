...
lp$1.parseStatement = function() {
  ...
  case __acorn.tokTypes._for:
    ...
    var isAwait = this.options.ecmaVersion >= 9 && this.in  && this.eatContextual("await");
...
lp$1.parseClass = function(isStatement) {
  ...
  while (!this.closes(__acorn.tokTypes.braceR, indent, line)) {
    ...
    var method = this$1.startNode(), isGenerator = (void 0), is  = (void 0);
    ...
    if (!method.computed &&
        method.key.type === "Identifier" && method.key.name === " " && this$1.tok.type !== __acorn.tokTypes.parenL &&
    ...
    if (this$1.options.ecmaVersion >= 5 && method.key.type === "Identifier" &&
      ...
      if (!method.computed && !method.static && !isGenerator && !is  && (
      ...
      method.value = this$1.parseMethod(isGenerator, is );
    }
...
lp$1.parseFunction = function(node, isStatement, is ) {
  var oldIn  = this.in ;
...
lp$1.parseExport = function() {
  ...
  if (this.eat(__acorn.tokTypes._default)) {
    ...
    var is ;
    if (this.tok.type === __acorn.tokTypes._function || (is  = this.toks.is Function())) {
      var fNode = this.startNode();
      this.next();
      if (is ) { this.next(); }
      node.declaration = this.parseFunction(fNode, "nullableID", is );
  ...
  if (this.tok.type.keyword || this.toks.isLet() || this.toks.is Function()) {
...
lp$2.parseMaybeUnary = function(sawUnary) {
  ...
  if (this.options.ecmaVersion >= 8 && this.in  && this.toks.isContextual("await")) {
...
lp$2.parseSubscripts = function(base, start, noCalls, startIndent, line) {
  ...
  for (;;) {
    ...
    var maybe Arrow = base.type === "Identifier" && base.name === " " && !this$1.canInsertSemicolon();
    ...
    if (this$1.eat(__acorn.tokTypes.dot)) {
      ...
      if (maybe Arrow && this$1.eat(__acorn.tokTypes.arrow))
...
lp$2.parseExprAtom = function() {
  ...
  case __acorn.tokTypes.name:
    ...
    var is  = false;
    if (id.name === " " && !this.canInsertSemicolon()) {
    ...
    return this.eat(__acorn.tokTypes.arrow) ? this.parseArrowExpression(this.startNodeAt(start), [id], is ) : id
...
lp$2.parseObj = function() {
  ...
  if (this.curIndent + 1 < indent) { indent = this.curIndent; line = this.curLineStart; }
  while (!this.closes(__acorn.tokTypes.braceR, indent, line)) {
    var prop = this$1.startNode(), isGenerator = (void 0), is  = (void 0), start = (void 0);
    ...
    if (this$1.eat(__acorn.tokTypes.colon)) {
      ...
      prop.kind = "init";
      prop.method = true;
      prop.value = this$1.parseMethod(isGenerator, is );
...
lp$2.parseMethod = function(isGenerator, is ) {
  var node = this.startNode(), oldIn  = this.in ;
  this.initFunction(node);
  if (this.options.ecmaVersion >= 6)
...
lp$2.parseArrowExpression = function(node, params, is ) {
  var oldIn  = this.in ;
  this.initFunction(node);
  if (this.options.ecmaVersion >= 8)
    { node.  = !!is ; }
