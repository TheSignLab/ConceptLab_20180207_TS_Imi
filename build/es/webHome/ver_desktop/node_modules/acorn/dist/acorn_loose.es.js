...
lp$1.parseClass = function(isStatement) {
  ...
  while (!this.closes(tokTypes.braceR, indent, line)) {
    ...
    if (!method.computed &&
        method.key.type === "Identifier" && method.key.name === " " && this$1.tok.type !== tokTypes.parenL &&
...
lp$1.parseExport = function() {
  ...
  if (this.eat(tokTypes._default)) {
    ...
    var is ;
    if (this.tok.type === tokTypes._function || (is  = this.toks.is Function())) {
...
lp$2.parseSubscripts = function(base, start, noCalls, startIndent, line) {
  ...
  for (;;) {
    ...
    if (this$1.eat(tokTypes.dot)) {
      ...
      if (maybe Arrow && this$1.eat(tokTypes.arrow))
...
lp$2.parseExprAtom = function() {
  ...
  case tokTypes.name:
    ...
    return this.eat(tokTypes.arrow) ? this.parseArrowExpression(this.startNodeAt(start), [id], is ) : id
