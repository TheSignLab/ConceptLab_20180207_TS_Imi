function updateFloatingFooter(o) {
    3 == o || 4 == o ? $("footer").show() : $("footer").hide()
}
...
function getColorByCookie() {
    ...
    o || (o = 0);
    var e = "c" + o;
    $(".c0").removeClass("c0").addClass(e), $(".c1").removeClass("c1").addClass(e), $(".c2").removeClass("c2").addClass(e), $(".c3").removeClass("c3").addClass(e), $(".c4").removeClass("c4").addClass(e), $(".c5").removeClass("c5").addClass(e)
}
